import {
  // App, Editor,
  MarkdownView, Modal, Notice, Plugin, PluginSettingTab, Setting, addIcon
} from 'obsidian'

import {
  changeCredentials,
  askClaude,
} from './bedrock-tools.js'
// } from '../../../../tools'
 ...
 *
 *
 * @param {TextractClient} client
 * @param {ArrayBuffer} image
 * @return {Promise<string>} 
 */
async function textFromImage(client, image) {
 ...
 * @return {*} 
 */
async function queryTimestream(client, query, params) {
...
/**
 * @typedef {Object} ObsiBotPluginSettings
 * @param {string} awsKeyId
 * @param {string} awsSecretKey
 * @param {string} awsSessionToken
 * @param {boolean} alwaysInsertAtTheEnd
 */

/** @type {ObsiBotPluginSettings} */
...
export default class ObsiBotPlugin extends Plugin {
  ...
  async onload() {
    ...
    this.addRibbonIcon('microscope', 'extract text from image', async (event/**@param {MouseEvent} event */) => {
    ...
    // const readTextBtn = 
    this.addRibbonIcon('audio-waveform', 'Read out loud', async (event) => {
      ...
      */
       ...
       * @return {*} 
       */
      async function textToSpeech(client, text, options) {
        // const voices = {
        //   'en': ['Emma'],
        //   'es': ['Lucia']
        // }
        ...
        /** @type {ReadableStream} */
        let audioStream = new ReadableStream()
    ...
    const promptBotBtn = this.addRibbonIcon('bot', 'ObsiBot', async (evt) => {
    ...
    // const queryDBBtn = 
    this.addRibbonIcon('database', 'Query DB', async (evt) => {
      // Called when the user clicks the icon.
...
class SampleSettingTab extends PluginSettingTab {
   ...
   *
   * @type {ObsiBotPlugin}
   * @memberof SampleSettingTab
   */
  plugin;

  /**
   * Creates an instance of SampleSettingTab.
   * @param {App} app
   * @param {ObsiBotPlugin} plugin
   * @memberof SampleSettingTab
   */
